...
contract LockToken is Ownable {
    ...
    modifier open(address from, address to) {
        require(tradable || _whiteList[from] || _whiteList[to], "Not Open");
        _;
    }
...
contract AVATAR is Context, IERC20, Ownable, LockToken 
{
    ...
    string private _name = "AVATAR INU";
    string private _symbol = "$AVATAR";
